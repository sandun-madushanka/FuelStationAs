...
<html>
    ...
    <body onload="invemtryStockDetailsloadtb()">
        <%
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <br/>
                                        <h5 class="title"><a href="inventry.jsp"> Back </a></h5>
                                    </div>
                                    <div class="content">

                                        <div class="header">
                                            <h4 class="title">Retrieve Stock Details from Here</h4>
                                        </div>
