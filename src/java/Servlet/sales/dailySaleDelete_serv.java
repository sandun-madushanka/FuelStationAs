 ...
 * @author Sandun
 */
@WebServlet(name = "dailySaleDelete_serv", urlPatterns = {"/dailySaleDelete_serv"})
public class dailySaleDelete_serv extends HttpServlet {
...
//                System.out.println("user kenek innawaa----------------");
                ...
                cr.add(Restrictions.eq("iddailysales", Integer.parseInt(nic)));
