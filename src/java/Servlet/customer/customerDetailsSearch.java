 ...
 * @author Sandun
 */
@WebServlet(name = "customerDetailsSearch", urlPatterns = {"/customerDetailsSearch"})
public class customerDetailsSearch extends HttpServlet {
...
//                System.out.println("user kenek innawaa----------------");
                ...
                if (cr.list().isEmpty()) {
                    ...
                    u_object.put("lcardStat", u.getLoyaltycard());
